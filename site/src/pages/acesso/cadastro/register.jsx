...
function Register() {
    ...
    async function createUsers() {
        try {
            ...
            // Verifica se já existe usuário com mesmo nome e email
            ...
            if (!alreadyExists) {
                ...
                // Redireciona para a página principal com o ID do usuário criado
            ...
            alert("Erro ao criar usuário. Tente novamente trocando o email ou nome.");
        }
    }
